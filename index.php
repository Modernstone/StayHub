    ...
    <div>
      ...
      <div class="home-container">
        <div class="home-header">
          ...
          >
            <a href="index.html" class="home-logo logo">STAYHUB</a>
            <div data-thq="thq-navbar-nav" class="home-desktop-menu">
              <nav class="home-links">
                <a href="index.html" class="home-nav12 bodySmall">Home</a>
                <a href="hotels.html" class="home-nav32 bodySmall">Hotels</a>
                <a href="plans.html" class="home-nav42">Plans</a>
                <a href="faq.html" class="home-nav22">FAQ</a>
                <a href="support.html" class="home-nav52">Support</a>
              </nav>
            ...
            >
              <div class="home-nav">
                ...
                <nav class="home-links1">
                  ...
                  <span class="home-nav221 bodySmall">Search</span>
                  <span class="home-nav321 bodySmall">Hotels</span>
                  <span class="home-nav421 bodySmall">Destinations</span>
            ...
            <div class="home-container1">
              ...
              <span class="home-hero-sub-heading bodyLarge">
                <span>
                  <span>
                    <span>
                      StayHub - Your one-stop destination for hotel bookings
                    </span>
                    <span></span>
                  </span>
                  <span>
              ...
              <div class="home-btn-group">
                <a href="hotels.html" class="home-hero-button1 buttonFilled">
                  Search Now
                </a>
              </div>
            </div>
        ...
        <div class="home-hero2">
          <h1 class="home-text14">Let\'s keep things organised</h1>
            ...
            <div class="home-features1">
              <div class="home-container3">
                ...
                <h2 class="home-features-heading heading2">
                  Discover the StayHub Advantage
                </h2>
                <span class="home-features-sub-heading bodyLarge">
                  <span>
                    <span>
                      <span>
                        Experience hassle-free hotel booking with StayHub
                      </span>
                      <span></span>
                    </span>
                    <span>
              ...
              <div class="home-container4">
                <div class="featuresCard feature-card-feature-card">
                  ...
                  <div class="feature-card-container">
                    ...
                    <span class="bodySmall">
                      <span>
                        Some platforms offer flexible booking options, including
                        free cancellation or modification within a certain time
                        frame.
                      </span>
                    </span>
                  </div>
                ...
                <div class="featuresCard feature-card-feature-card">
                  ...
                  <div class="feature-card-container">
                    ...
                    <span class="bodySmall">
                      <span>
                        Users can access special deals, discounts, and
                        promotional offers for hotels, making their stay more
                        affordable.
                      </span>
                    </span>
                  </div>
                ...
                <div class="featuresCard feature-card-feature-card">
                  ...
                  <div class="feature-card-container">
                    ...
                    <span class="bodySmall">
                      <span>
                        Find the lowest prices for your desired accommodations
                      </span>
                    </span>
                  </div>
                </div>
                <div class="featuresCard feature-card-feature-card">
                  ...
                  <div class="feature-card-container">
                    ...
                    <span class="bodySmall">
                      <span>
                        Access to customer support via phone, email, or live
                        chat helps users with any queries or issues they may
                        encounter during the booking process or their stay.
                      </span>
                    </span>
                  </div>
                </div>
        ...
        <div class="home-banner">
          <div class="home-banner1 bannerContainer">
            ...
            <span class="home-banner-sub-heading bodySmall">
              <span>
                <span>
                  <span>
                    At StayHub, we strive to provide you with the best hotel
                    booking experience. With a wide range of hotels to choose
                    from, you can find the perfect accommodation that suits your
                    needs and budget. Whether you are planning a business trip,
                    family vacation, or romantic getaway, StayHub has got you
                    covered.
                  </span>
                  <span></span>
                </span>
            ...
            <a href="hotels.html" class="home-banner-button buttonFilled">
              Book Now
            </a>
          </div>
        </div>
        <div class="home-stats">
          <div class="home-stat">
            <svg viewBox="0 0 1152 1024" class="home-icon10">
              <path
            ...
            <span class="home-text53">Customers</span>
            <h1 class="home-text54">50+</h1>
          </div>
          <div class="home-stat1">
            ...
            <span class="home-text55">Hotel &amp; Resourts</span>
            <h1 class="home-text56">15+</h1>
          </div>
          <div class="home-stat2">
            ...
            <span class="home-text57">Cities</span>
            <h1 class="home-text58">20+</h1>
          </div>
        </div>
        <div class="home-footer">
          <footer class="footerContainer home-footer1">
            <div class="home-container5">
              <span class="logo">STAYHUB</span>
              <nav class="home-nav1">
                <a href="index.html" class="home-nav122 bodySmall">Home</a>
                <a href="hotels.html" class="home-nav222 bodySmall">Hotels</a>
                <a href="plans.html" class="home-nav322 bodySmall">Plans</a>
                <a href="faq.html" class="home-nav422 bodySmall">FAQ</a>
                <a href="support.html" class="home-nav522 bodySmall">Support</a>
              </nav>
            </div>
            <div class="home-separator"></div>
            <div class="home-container6">
              <span class="bodySmall home-text59">
                © 2023 STAYHUB, All Rights Reserved.
              </span>
              <div class="home-icon-group1">
                <svg
                  viewBox="0 0 950.8571428571428 1024"
                  class="home-icon17 socialIcons"
                >
                  <path
                    d="M925.714 233.143c-25.143 36.571-56.571 69.143-92.571 95.429 0.571 8 0.571 16 0.571 24 0 244-185.714 525.143-525.143 525.143-104.571 0-201.714-30.286-283.429-82.857 14.857 1.714 29.143 2.286 44.571 2.286 86.286 0 165.714-29.143 229.143-78.857-81.143-1.714-149.143-54.857-172.571-128 11.429 1.714 22.857 2.857 34.857 2.857 16.571 0 33.143-2.286 48.571-6.286-84.571-17.143-148-91.429-148-181.143v-2.286c24.571 13.714 53.143 22.286 83.429 23.429-49.714-33.143-82.286-89.714-82.286-153.714 0-34.286 9.143-65.714 25.143-93.143 90.857 112 227.429 185.143 380.571 193.143-2.857-13.714-4.571-28-4.571-42.286 0-101.714 82.286-184.571 184.571-184.571 53.143 0 101.143 22.286 134.857 58.286 41.714-8 81.714-23.429 117.143-44.571-13.714 42.857-42.857 78.857-81.143 101.714 37.143-4 73.143-14.286 106.286-28.571z"
                  ></path></svg
